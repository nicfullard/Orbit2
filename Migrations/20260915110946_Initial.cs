        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiKeys_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurringTaskDefinitions", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringTaskDefinitions_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringTaskDefinitions_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringTaskDefinitions_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurringTaskDefinitionId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_RecurringTaskDefinitions_RecurringTaskDefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTaskDefinitions_Active_NextRunDate",
                table: "RecurringTaskDefinitions",
                columns: new[] { "Active", "NextRunDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTaskDefinitions_CreatedById",
                table: "RecurringTaskDefinitions",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringTaskDefinitions_DepartmentId",
                table: "RecurringTaskDefinitions",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringTaskDefinitions_ProjectId",
                table: "RecurringTaskDefinitions",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Sprints_SingleActive",
                table: "Sprints",
                column: "Status",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_RecurringTaskDefinitionId_DueDate",
                table: "Tasks",
                columns: new[] { "RecurringTaskDefinitionId", "DueDate" });
